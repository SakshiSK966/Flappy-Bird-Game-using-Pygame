...
BACKGROUND_IMAGE = pygame.image.load('img1.jpg')
BACKGROUND_IMAGE = pygame.transform.scale(BACKGROUND_IMAGE, (SCREEN_WIDTH, SCREEN_HEIGHT))


BIRD_IMAGE = pygame.image.load('Birrrd.png')
BIRD_IMAGE = pygame.transform.scale(BIRD_IMAGE, (50, 30))
bird_x = 50
bird_y = 300
bird_y_change = 0
...
while running:
    ...
    if bird_y >= 571:
        bird_y = 571
        pygame.time.delay(1000)  # Wait for 1 second before ending
        waiting = True 
    # Moving the obstacle
